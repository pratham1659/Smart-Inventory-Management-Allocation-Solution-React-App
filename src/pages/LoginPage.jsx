            ...
            <CardContent className="p-6">
              <div className="space-y-6">
                <div className="space-y-2 text-center">
                  <h1 className="text-2xl font-bold"> {isLoginForm ? "Sign in to your account" : "Reset your password"}</h1>
                </div>
                {isLoginForm ? (
                  <form className="space-y-2">
                    ...
                    <div className="text-right">
                      <Link onClick={toggleForm} className="text-sm text-blue-700 hover:text-blue-500 hover:no-underline">
                        Forgot Password?
                      </Link>
                    </div>
                  ...
                  <form className="space-y-4">
                    ...
                    <div className="text-center">
                      <Button variant="link" className="p-0 h-auto font-normal" onClick={toggleForm}>
                        Back to Sign In
                      </Button>
                    </div>
                  </form>
                ...
                <div className="text-center text-sm">
                  <span className="text-muted-foreground">{isLoginForm ? "Don't have an account?" : "Remember your password?"}</span>{" "}
                  <Link to={isLoginForm ? "/register" : "/login"} className="text-sm text-blue-700 hover:text-blue-500 no-underline">
